...
public class EbayService {
    ...
    public List<ComparisonProduct> fetchProducts(String query) {
        ...
        try {
            ...
            // If dummy token is used, return mock data
            if ("dummy-dev-token".equals(token)) {
                results.add(new ComparisonProduct("Sample eBay Product", 99.99, "USD",
                        "https://via.placeholder.com/150", "eBay", "https://www.ebay.com/"));
                return results;
            }
            ...
            if (items != null && items.isArray()) {
                for (JsonNode item : items) {
                    ...
                    results.add(new ComparisonProduct(
                            title, price, currency, imageUrl, "eBay", itemLink
                    ));
                }
            }
